...
class DoctorsController extends Controller
{
	...
	public function CreateDoctor(Request $request)
    {
    	try{
    		...
    		$doctor->uhl_id = $request->doctor_uhl_id;
    		$doctor->bmdc_id = $request->doctor_bmdc_id;
    ...
    public function UpdateDoctor(Request $request, $id)
    {
    	try{
    		...
    		$doctor['uhl_id'] = $request->input('edit_doctor_uhl_id');
    		$doctor['bmdc_id'] = $request->input('edit_doctor_bmdc_id');
