...
Route::group(['middleware' => ['api'], 'prefix' => 'department'], function ($router) {
    ...
    Route::get('/getdoctorbydepartment/{id}', [App\Http\Controllers\Api\DepartmentController::class, 'getDoctorByDepartment']);
...
Route::group(['middleware' => ['api'], 'prefix' => 'newsevents'], function ($router) {
    ...
    Route::get('/getdoctorpublications/{id}', [App\Http\Controllers\Api\PublicationsController::class, 'GetDoctorPublications']);
...
Route::group(['middleware' => ['api'], 'prefix' => 'publications'], function ($router) {
    ...
    Route::get('/getdoctors', [App\Http\Controllers\Api\PublicationsController::class, 'GetDoctors']);
     Route::get('/getdoctorpublicationname/{id}', [App\Http\Controllers\Api\PublicationsController::class, 'GetDoctorPublicationsName']);
...
Route::group(['middleware' => ['api'], 'prefix' => 'doctors'], function ($router) {
    ...
    Route::get('/getsingledoctorprofiledata/{id}', [App\Http\Controllers\Api\DoctorsController::class, 'GetSingleDoctorProfileData']);
    ...
    Route::get('/getsingledoctorsdetails/{id}', [App\Http\Controllers\Api\DoctorsController::class, 'GetSingleDoctorsDetails']);
    
    
    Route::get('/doctorpublication/{id}', [App\Http\Controllers\Api\DoctorsController::class, 'DoctorsPublication']);
...
Route::group(['middleware' => ['api'], 'prefix' => 'staticpages'], function ($router) {
    ...
    Route::get('/getsinglestaticpage/{id}', [App\Http\Controllers\Api\StaticPagesController::class, 'GetSingleStaticPage']);
